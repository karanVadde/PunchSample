package com.meerkat.punchtest.notification
...
import com.meerkat.punchtest.AppContainer.Companion.toDoListDatabase
import com.meerkat.punchtest.R
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        //log the alert shown event.
        AnalyticsEngine.logEvent(AnalyticsEngine.ALT_SHW_EVT, dbId.toString(),
            "", "")
    }
    ...
    private fun initiateDatabase(context: Context) {
        if (toDoListDatabase == null) toDoListDatabase = ToDoListDatabase.getInstance(context)
        //
